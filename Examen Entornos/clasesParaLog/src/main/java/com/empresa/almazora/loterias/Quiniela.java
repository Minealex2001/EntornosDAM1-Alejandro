...
public class Quiniela {
    ...
    private static final Logger log = LogManager.getLogger(Quiniela.class);
    public Quiniela() {
    ...
    public double juegaQuiniela() throws IOException {
        ...
        log.trace("Inicio del método {juegaQuiniela}");
        log.info("Inicio del método {juegaQuiniela}");
        log.warn("Inicio del método {juegaQuiniela}");
        log.error("Incio del método {juegaQuiniela}");
